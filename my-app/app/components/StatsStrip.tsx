...
const stats = [
  ...
  { value: String(roles.length), label: "Giai cấp, tầng lớp cơ bản ở Việt Nam" },
  { value: String(timeline.length), label: "Mốc lịch sử tiêu biểu trong dòng thời gian" },
];
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-6 py-10 sm:grid-cols-4">
        {stats.map((s) => (
          <div key={s.label} className="text-center">
            <p className="text-3xl font-extrabold text-brand-gold sm:text-4xl">
              {s.value}
            </p>
